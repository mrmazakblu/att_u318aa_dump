...
BUILD_MD32 = no
BUILD_PRELOADER = yes
CUSTOM_BUILD_VERNO = U318AAV02.51.11
...
CUSTOM_HAL_IMGSENSOR = gc5035_st_u318_rear_mipi_raw gc5035_ct_u318_rear_mipi_raw gc5035_st_u318_front_mipi_raw st55a_kmj_u318_mipi_raw
CUSTOM_HAL_MAIN2_IMGSENSOR =
CUSTOM_HAL_MAIN_IMGSENSOR = gc5035_st_u318_rear_mipi_raw gc5035_ct_u318_rear_mipi_raw
CUSTOM_HAL_MSENSORLIB =akm
CUSTOM_HAL_SENSORS = sensor
CUSTOM_HAL_SUB_IMGSENSOR = gc5035_st_u318_front_mipi_raw st55a_kmj_u318_mipi_raw
...
CUSTOM_KERNEL_IMGSENSOR = gc5035_st_u318_rear_mipi_raw gc5035_ct_u318_rear_mipi_raw gc5035_st_u318_front_mipi_raw st55a_kmj_u318_mipi_raw
...
CUSTOM_KERNEL_MAIN_IMGSENSOR = gc5035_st_u318_rear_mipi_raw gc5035_ct_u318_rear_mipi_raw
...
CUSTOM_KERNEL_SUB_IMGSENSOR = gc5035_st_u318_front_mipi_raw st55a_kmj_u318_mipi_raw
...
MTK_PERSIST_PARTITION_SUPPORT = yes# zwli
#MTK_PRODUCT_PARTITION_SUPPORT = yes# zwli 默认没有这一行
...
#tinno modify by shufeng.liu for UDBIAA-917 begin
MTK_DURASPEED_DEFAULT_ON = no
MTK_DURASPEED_SUPPORT = no
#tinno modify by shufeng.liu for UDBIAA-917 end
SYSTEM_AS_ROOT = yes
MTK_UFS_SUPPORT = no
...
CUSTOM_BUILD_VERNO = U318AAV02.51.11
INTERNAL_BUILD_VERNO = U318AA_10.0_M30_ES_51
TCUSTOM_BUILD_VERNO = U318AAV02.51.11

#IPME case 5220 fail reason
TINNO_SYSTEM_PROPERTY_OVERRIDES += persist.vendor.service.tag.rcs=525
TINNO_PRJ_DIR=vendor/tinno/product/$(MTK_TARGET_PROJECT)/$(PROJECT_NAME)

#BUILD GMS
ifeq ($(TARGET_BUILD_MINI_VERSION),false)
BUILD_GMS = yes
endif
#TINNO BEGIN for carrier parttion # zwli
FEATURE_CARRIER_PARTITION_SUPPORT = yes
#TINNO END

#TINNO BEGIN for MAPI
...
#tinno modify UAAMTQ-1259 by wang.peng ,Controll RCS feature options 20190829
ifeq ($(strip $(TINNO_BUILD_GCF)),true)
MTK_RCS_UA_SUPPORT = no
MTK_RCS_SUPPORT = no
MTK_UCE_SUPPORT = no
MTK_ACS_SUPPORT_BY_TINNO = no
else
MTK_RCS_UA_SUPPORT = no
MTK_RCS_SUPPORT = no
MTK_UCE_SUPPORT = no
...
#add by wangchao for UDBIAA-334
TINNO_RO_TARGET = U318AA
